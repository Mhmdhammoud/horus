...
from horus_source.core.ingestion.imports import (
    build_file_index,
    process_imports,
    resolve_import_path,
)
from horus_source.core.ingestion.parser_phase import FileParseData
from horus_source.core.parsers.base import ImportInfo, ParseResult
...
class TestResolvePythonAbsoluteWithSourceRoot:
    def test_resolve_absolute_with_src_prefix(self) -> None:
        ...
        index = build_file_index(g)
        from horus_source.core.ingestion.imports import _detect_source_roots
